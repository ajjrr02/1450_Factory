...
! function(t) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = g, e.getIn = _, e.set = m, e.setIn = y, e.update = I, e.updateIn = b, e.merge = T, e.mergeDeep = O, e.mergeIn = w, e.omit = A, e.addDefaults = S;
    /*!
     * Timm
     *
    ...
    window.tram = function(t) {
        ...
        C.transform && (Q.transform = [V], q = {
            ...
            skewX: [b],
            skewY: [b]
        }), C.transform && C.backface && (q.z = [I, "translateZ"], q.rotateZ = [b], q.scaleZ = [_], q.perspective = [y]);
        var $ = /ms/,
            Z = /s|\./;
        return t.tram = e
    }(window.jQuery)
                                    ...
                                    a && t.forEach(function(t, i) {
                                        ...
                                        ! function(t) {
                                            var e = t.store,
                                                ...
                                                b = c.id;
                                            V(E, a) && (b = U(n, b));
                                            var T = v.hasBoundaryNodes && i ? m.getClosestElement(i, w) : null;
    ...
    function ht(t) {
        ...
        (0, v.default)(n, function(t) {
            if (!t.continuous) {
                var n = t.actionListId,
                    r = t.verbose;
                mt(t, e), r && e.dispatch((0, _.actionListPlaybackChanged)({
                    actionListId: n,
                    isPlaying: !1
                }))
            }
    ...
    function _t(t) {
        ...
        r.dispatch((0, _.instanceAdded)((0, a.default)({
            ...
            onChange: It
        }), h && r.dispatch((0, _.instanceStarted)(g, b.tick)))
    }
    ...
    function mt(t, e) {
        ...
        var n = t.elementId,
            ...
            o = i.ref;
        i.refType === A && B(o, r, m), e.dispatch((0, _.instanceRemoved)(t.id))
    }
        ...
        if (W(w, T.mediaQueryKey) && (r || n || i)) {
            ...
            if (i) {
                if (h) {
                    ...
                    g && !D && e.dispatch((0, _.actionListPlaybackChanged)({
                        actionListId: v,
                        isPlaying: !1
                    }))
                }
    ...
    t.exports = function(t, e, n, E, g, _) {
        ...
        if (w && !T) return _ || (_ = new r), m || f(t) ? i(t, e, n, E, g, _) : o(t, e, I, n, E, g, _);
        if (!(n & l)) {
                    ...
                    switch (u) {
                        ...
                        case ut:
                            var g = lt[u],
                                ...
                                I = n.aValue;
                            xt(t, g, o), a(t, g, I >= 1 ? "rgb(".concat(_, ",").concat(m, ",").concat(y, ")") : "rgba(".concat(_, ",").concat(m, ",").concat(y, ",").concat(I, ")"));
                            break;
                        default:
                            var b = c.unit,
                                T = void 0 === b ? "" : b;
    ...
    var f = s(n(270)),
        ...
        dt = Object.freeze((i = {}, (0, c.default)(i, _.TRANSFORM_PREFIXED, I), (0, c.default)(i, P, y), (0, c.default)(i, N, N), (0, c.default)(i, C, C), (0, c.default)(i, L, L), (0, c.default)(i, D, D), i)),
        pt = {},
        vt = 1;
    var ht = 1;
    var Et = function(t, e) {
    ...
    function _t(t) {
        ...
        var x, N, C, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[b || O] || {},
        ...
        return null == N || null == C ? [] : _.IS_BROWSER_ENV && u ? d(C).filter(function(t) {
            return u.contains(t)
        }) : x === F ? d(N, C) : x === k ? p(d(N)).filter(E(C)) : x === X ? h(d(N)).filter(E(C)) : d(C)
    }
    var mt = /px/,
        yt = function(t, e) {
        ...
        b = function(t, e) {
            ...
            for (var S = 0, R = i.length; S < R; S++) {
                ...
                if (0 === S && (_ = C[0]), A >= N) {
                    ...
                    var L = i[S + 1],
                        D = L && A !== N;
                    y = D ? L.actionItems[0] : null, D && (I = N / 100, b = (L.keyframe - N) / 100)
                }
            }
            var P = {};
            if (_ && !y)
                for (var M = 0, j = a.length; M < j; M++) {
                    ...
                    for (var k = (w - I) / b, X = _.config.easing, G = h(X, k, f), V = 0, U = a.length; V < U; V++) {
                        var W = a[V],
                            B = m(s, W, _.config),
    ...
    t.exports = function(t, e, n) {
        ...
        return e = o(e) || 0, r(n) && (E = !!n.leading, l = (g = "maxWait" in n) ? u(o(n.maxWait) || 0, e) : l, _ = "trailing" in n ? !!n.trailing : _), T.cancel = function() {
            ...
            handler: function(t) {
                ...
                switch (u) {
                    case h.EventBasedOn.VIEWPORT:
                        w = T ? Math.min(v, window.innerWidth) / window.innerWidth : Math.min(_, window.innerHeight) / window.innerHeight;
                        break;
                    case h.EventBasedOn.PAGE:
                        var R = ut(),
                            ...
                            C = R.scrollWidth,
                            L = R.scrollHeight;
                        w = T ? Math.min(x + y, C) / C : Math.min(N + b, L) / L;
                        break;
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function y(e, n) {
                ...
                ! function(e, n) {
                    ...
                    function O(t) {
                        var r = t.responseJSON && t.responseJSON.msg,
                            i = y;
                        "string" == typeof r && 0 === r.indexOf("InvalidFileTypeError") ? i = m : "string" == typeof r && 0 === r.indexOf("MaxFileSizeError") && (i = _), p.text(i), f.removeAttr("data-value"), f.val(""), a.toggle(!1), o.toggle(!0), s.toggle(!0), s.focus(), n.fileUploads[e].uploading = !1, S() || I(n)
                    }
            ...
            i.handler = null, i.redirect = r.attr("data-redirect"), _.test(s) ? i.handler = A : s || (o ? i.handler = w : m())
        }
    ...
    r.define("navbar", t.exports = function(t, e) {
        ...
        function X(t, e) {
            if (!t.open) {
                t.open = !0, t.menu.each(F), t.links.addClass(I), t.dropdowns.addClass(_), t.dropdownToggle.addClass(m), t.dropdownList.addClass(y), t.button.addClass(g);
                var n = t.config;
        ...
        function V(t, e) {
            ...
            function c() {
                t.menu.height(""), f(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.each(k), t.links.removeClass(I), t.dropdowns.removeClass(_), t.dropdownToggle.removeClass(m), t.dropdownList.removeClass(y), t.overlay && t.overlay.children().length && (T.length ? t.menu.insertAfter(T) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close"), t.button.attr("aria-expanded", "false")
            }
        }
        return s
    })
    ...
    r.define("tabs", t.exports = function(t) {
        ...
        function _() {
            n = f && r.env("design"), (e = u.find(p)).length && (e.each(I), r.env("preview") && !g && e.each(y), m(), r.redraw.on(o.redraw))
        }
        ...
        function b(e, n) {
            ...
            if (u !== e.current) {
                ...
                var m = window.scrollX,
                    y = window.scrollY;
                c.focus(), window.scrollTo(m, y), _.length && i.outro ? (_.each(E.outro), a(_).add("opacity " + i.outro + "ms " + o, {
                    fallback: s
                }).start({
                    opacity: 0
                }).then(function() {
...
Webflow.require('ix2').init({
    "events": {
        ...
        "e-46": {
            ...
            "target": {
                "id": "623b58ac191ec56a9a8aee31|8be34e10-d604-d5cb-e27e-e020152cb6f6",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-56": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "627d1d56d87d4844abc169c0|4b915fc6-1bbe-966a-5ccb-77a62ff06f16",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-58": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "627d1d56d87d4844abc169c0|e138f8bd-a818-dd32-19f2-3f9cb159c599",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-60": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "627d1d56d87d4844abc169c0|85757049-25ab-8d4b-f77a-51622abf26ac",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-62": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "627d1d56d87d4844abc169c0|ab2ea2fe-5c9e-253a-051a-aeeb4c048b7e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-92": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "62d5b24eb10f0b7387bcc652|8be34e10-d604-d5cb-e27e-e020152cb6f6",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
    ...
    "actionLists": {
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selectorGuids": ["745d50d3-494d-65e1-14b9-9d2366452e4a"]
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "px",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".faq-answer",
                            "selectorGuids": ["8a870001-c0ea-ddde-d938-af6b1dc233e2"]
                        },
                        "heightValue": 0,
                        "widthUnit": "AUTO",
                        "heightUnit": "PX",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".plus-vert",
                            "selectorGuids": ["8a870001-c0ea-ddde-d938-af6b1dc233de"]
                        },
                        "heightValue": 0,
                        "widthUnit": "AUTO",
                        "heightUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["8a870001-c0ea-ddde-d938-af6b1dc233e0"]
                        },
                        "zValue": 180,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
        ...
        "a-13": {
            "id": "a-13",
            "title": "Sticky  Main Navbar With Banner",
            "continuousParameterGroups": [{
                "id": "a-13-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
        ...
        "a-6": {
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "selector": ".top-navbar",
                                "selectorGuids": ["35bb7d06-96b7-c990-982f-57a398e92fcc"]
                            },
                            "value": 1,
                            "unit": ""
                        }
            ...
            "createdOn": 1652207653730
        },
        "a-7": {
            "id": "a-7",
            "title": "Mobile Sticky Main Navbar",
            "continuousParameterGroups": [{
                "id": "a-7-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "f956962d-c8e1-ec56-40d5-64cea2dc14c3"
                            },
                            "heightValue": 80,
                            "widthUnit": "PX",
                            "heightUnit": "px",
            ...
            "createdOn": 1652207871751
        },
        "a-11": {
            "id": "a-11",
            "title": "Hide Navbar Banner",
            "continuousParameterGroups": [{
                "id": "a-11-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "selector": ".navbar-banner",
                                "selectorGuids": ["06aa8a35-3532-9686-0549-91a0502dcd34"]
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "px",
            ...
            "createdOn": 1653189329729
        },
        "a-16": {
            "id": "a-16",
            "title": "FunPage: Sticky  Main Navbar With Banner 2",
            "continuousParameterGroups": [{
                "id": "a-16-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
        ...
        "a-14": {
            "id": "a-14",
            "title": "Mobile Sticky Main Navbar 2",
            "continuousParameterGroups": [{
                "id": "a-14-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "62a47a9b944e79430729387d|f956962d-c8e1-ec56-40d5-64cea2dc14c3"
                            },
                            "heightValue": 80,
                            "widthUnit": "PX",
                            "heightUnit": "px",
        ...
        "a-19": {
            "id": "a-19",
            "title": "Mobile Sticky Main Navbar 5",
            "continuousParameterGroups": [{
                "id": "a-19-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "62d5b24eb10f0b7387bcc652|f956962d-c8e1-ec56-40d5-64cea2dc14c3"
                            },
                            "heightValue": 80,
                            "widthUnit": "PX",
                            "heightUnit": "px",
